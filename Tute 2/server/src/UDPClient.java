...
public class UDPClient {
    public static void main(String[] args) {
        ...
        try {
            System.out.println("Type out a message for the server!");
            ...
            // Because UDP Datagrams are bounded by fixed message boundaries, define the length
            ...
            // Create a reception Datagram packet and receive through socket
